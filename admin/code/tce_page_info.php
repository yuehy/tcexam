...
echo '<li><strong>'.$l['w_author'].':</strong> 南京灵雀</li>'.K_NEWLINE;
echo '<li><strong>Copyright:</strong><br /> (c) 2017 Nanjing Smartbird Intelligence Technology Co., LTD<br />'.K_NEWLINE;
